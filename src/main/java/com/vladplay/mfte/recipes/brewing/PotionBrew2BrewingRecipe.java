...
public class PotionBrew2BrewingRecipe implements IBrewingRecipe {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> BrewingRecipeRegistry.addRecipe(new PotionBrew2BrewingRecipe()));
	}
	...
	public boolean isIngredient(ItemStack ingredient) {
		return Ingredient.of(new ItemStack(MorefoodthaneverModItems.NIGHT_VISION_EYE.get())).test(ingredient);
	}
